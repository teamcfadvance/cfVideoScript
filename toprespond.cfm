...
<cfset toprespond = #yt.getMostRespondedVideos("#url.time#",1,50)#>
<cfelse>
<cfset toprespond = #yt.getMostRespondedVideos("",1,50)#>
</cfif>
<cfset tock = GetTickCount()>
<table align="center" width="100%">
<cfoutput>
<cfset _searchtime = (tock - tick)/1000> 
<tr><td colspan="4"><div style="float:left;">Fetching data took <b class="errString">#_searchtime#</b> (locally) seconds</div><div style="float:right;">&nbsp;&nbsp;<a href="videos.cfm?action=toprespond&time=today" title="Show Todays's Top viewed videos">Today</a> | <a href="videos.cfm?action=toprespond&time=this_week" title="Show this week's top viewed videos">This week</a> | <a href="videos.cfm?action=toprespond&time=this_month" title="Show this month's top viewed videos">This Month</a> | <a href="videos.cfm?action=toprespond&time=all_time" title="Ahow all time Top viewed Videos">All Time</a></div></td></tr>
</cfoutput>
<cfif toprespond.recordcount>
<cfinclude template="paging.cfm">
	<br />
    <div align="center">
    <cfoutput>
    Displaying <b>#pagination.getStartRow()#</b> to <b>#pagination.getMaxRows()#</b> of <b>#toprespond.total#</b> Records.
    </cfoutput>
    </div>
    <cfoutput>#pagination.getRenderedHTML()#</cfoutput>
    <cfoutput query="toprespond" startrow="#pagination.getStartRow()#" maxrows="#pagination.getMaxRows()#">
    <td height="30" valign="middle"><div class="leftcontentDIV" align="center"> <strong><a href="videos.cfm?action=show&ID=#ID#"> <img src="#thumbnail_url#" width="#thumbnail_width#" height="#thumbnail_height#" title="#title#" border="0"/></a><br>
      ...
      <cfif toprespond.currentRow MOD 4 EQ 0>
        </tr>
  ...
  <img src="images/smilo.gif" alt="No Top Linked Found" border="0" /><br /><br />
  No Linked Videos Found!
  </td></tr>
  </cfif>
  <tr>
</table>
