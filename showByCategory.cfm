...
<cfset ModifycatName = #Replace(url.catname,"%20","+","All")#>
<cfset showus = #yt.getVideosByCategoriesKeywords(categories='#ModifycatName#')#>
<cfset tock =  GetTickCount()>
<cfset variables.newrow = False>
<table align="center" width="100%">
<cfoutput>
<cfset _searchtime = (tock - tick)/1000><tr><td colspan="4"><div style="float:left;">Fetching data took <b class="errString">#_searchtime#</b> (locally) seconds</div><div style="float:right;">&nbsp;&nbsp;</div></td></tr>
</cfoutput>
  ...
  <cfinclude template="paging.cfm">
	...
	<cfset createImage = yt.getThumbnail(trim(ID))>
    <td height="30" valign="middle"><div class="leftcontentDIV" align="center"> <strong><a href="videos.cfm?action=show&myId=#ID#"> <img src="#createImage.thumb2#" width="#createImage.thumbwidth#" height=#createImage.thumbheight#" title="#title#" border="0"/></a><br>
  ...
  <tr>
      <td colspan="4" align="center"><img src="images/smilo.gif" alt="No videos Found" border="0" /><br />
        <br />
        No videos Found under category <strong><em>#url.catname#</em></strong>! </td>
    </tr>
    </cfoutput>
  </cfif>
  <tr>
