...
<cfset mostRecent = #yt.getRecentlyFeaturedVideos(1,50)#>
...
<tr><td colspan="4"><div style="float:left;">Fetching data took <b class="errString">#_searchtime#</b> (locally) seconds</div></td></tr>
  ...
  <cfif mostrecent.recordcount>
  <cfinclude template="paging.cfm">
	<br />
    <div align="center">
    <cfoutput>
    Displaying <b>#pagination.getStartRow()#</b> to <b>#pagination.getMaxRows()#</b> of <b>#mostrecent.total#</b> Records.
    </cfoutput>
    </div>
    <cfoutput>#pagination.getRenderedHTML()#</cfoutput>
    <cfoutput query="mostrecent" startrow="#pagination.getStartRow()#" maxrows="#pagination.getMaxRows()#">
    <tr  ><td height="30" valign="middle"><div class="leftcontentDIV" align="center"> <strong><a href="videos.cfm?action=show&ID=#ID#"> <img src="#thumbnail_url#" width="#thumbnail_width#" height="#thumbnail_height#" title="#title#" border="0"/></a><br>
      ...
      <cfif mostRecent.currentRow MOD 4 EQ 0>
        </tr>
    ...
    <cfelse>
    <tr>
      <td colspan="4" align="center"><img src="images/smilo.gif" alt="No Top Recent Featured videos Found" border="0" /><br />
        <br />
        No Top Recent Featured videos Found! </td>
    </tr>
  </cfif>
  <tr>
</table>
